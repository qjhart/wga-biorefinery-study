...
drop table if exists refineries.epa_facility_roads cascade;
create table refineries.epa_facility_roads as
...
create index epa_facility_road_p_gid on refineries.epa_facility_roads(p_gid);
create index epa_facility_road_r_gid on refineries.epa_facility_roads(r_gid);
